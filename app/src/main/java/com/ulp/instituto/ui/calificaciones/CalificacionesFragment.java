...
import com.ulp.instituto.databinding.FragmentCalificacionesBinding;
...
public class CalificacionesFragment extends Fragment {
    ...
    private CalificacionesViewModel mViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        CalificacionesViewModel mCalViewModel =
        ...
        mCalViewModel.getCalificacionesMutableLiveData().observe(getViewLifecycleOwner(), new Observer<String[][]>() {
